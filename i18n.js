...
const HOMEPAGE_I18N = {
  'zh-CN': {
    ...
    'contact.x':      'X / Twitter',
    'contact.bili':   '哔哩哔哩',
    'contact.biliValue': 'Bilibili',
    'contact.zhihu':  '知乎',
    'contact.zhihuValue': '知乎',

    'journey.title': '旅程',
    'journey.sub':   '走到这里的一段速写。',
    'journey1.date': '2024',
    'journey1.title': '开始写代码',
    'journey1.desc':  '学了第一门语言，也第一次明白自己还有多少不知道。',
    'journey2.date': '2025',
    'journey2.title': '做出第一批好用的工具',
    'journey2.desc':  '开始做那些真的能解决自己问题的小工具——「把东西做出来」从此上瘾。',
    'journey3.date': '2025',
    'journey3.title': '接触 AI 工具链',
    'journey3.desc':  '发现 Agent，围绕它搭起自己的工作流——体力活更快，把关更仔细。',
    'journey4.date': '2026',
    'journey4.title': '进入 Agent 驱动阶段',
    'journey4.desc':  '把方法论变成日常实践，持续发货，判断力始终留在自己手里。',
    'journey5.date': '2026',
    'journey5.title': '上线这个站和博客',
    'journey5.desc':  '一个安静写字的小角落。上线了，也会继续打磨下去。',
...
'blog.title': 'Writing',
    ...
    'repos.title': 'Recent repos',
    'repos.sub':   'Pulled live from GitHub.',
...
'contact.title':  'Get in touch',
    ...
    'contact.emailValue': '{{email}}',
    'contact.x':      'X / Twitter',
    'contact.bili':   'Bilibili',
    'contact.biliValue': 'Bilibili',
    'contact.zhihu':  'Zhihu',
    'contact.zhihuValue': 'Zhihu',

    'journey.title': 'Timeline',
    'journey.sub':   'A short version of the road here.',
    'journey1.date': '2024',
    'journey1.title': 'Started coding',
    'journey1.desc':  'Picked up my first language and realised how much I didn’t know.',
    'journey2.date': '2025',
    'journey2.title': 'First useful tools',
    'journey2.desc':  'Started shipping small tools that solved my own problems — building things stuck.',
    'journey3.date': '2025',
    'journey3.title': 'Picked up AI tooling',
    'journey3.desc':  'Discovered agents and built a workflow around them — faster on the grunt work, more careful at the checks.',
    'journey4.date': '2026',
    'journey4.title': 'Building agent-driven',
    'journey4.desc':  'Turned the practice into a habit — shipping projects while keeping the judgment mine.',
    'journey5.date': '2026',
    'journey5.title': 'Opened this site & blog',
    'journey5.desc':  'A calm corner for writing things down. Shipped — and a project I keep polishing.',
