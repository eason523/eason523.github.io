...
const HOMEPAGE_I18N = {
  'zh-CN': {
    ...
    'journey1.date': '2022',
    'journey1.title': '接触编程',
    'journey1.desc':  '开始学习人生第一门语言，敲下第一行代码，认识了这个世界有多深。',
    'journey2.date': '2024',
    'journey2.title': '第一次用 AI',
    'journey2.desc':  '第一次用 AI 写代码、查资料、动画上手——原来工具可以这么「顺手」。',
    'journey3.date': '2025',
    'journey3.title': '开始用 Agent',
    'journey3.desc':  '把日常的重复活交给 Agent，自己把住方向和判断，效率有了质的提升。',
    'journey4.date': '2026',
    'journey4.title': '做出这些项目',
    'journey4.desc':  '把攒下的想法一个个落地：开源搜索、对话树编辑器、足球比分预测，以及这个站和博客。',
...
'contact.title':  'Get in touch',
    ...
    'journey1.date': '2022',
    'journey1.title': 'Started programming',
    'journey1.desc':  'Learned my first language, typed my first lines, and saw how deep this world runs.',
    'journey2.date': '2024',
    'journey2.title': 'First used AI',
    'journey2.desc':  'Wrote code, searched, and got going with AI for the first time — how convenient a tool could be.',
    'journey3.date': '2025',
    'journey3.title': 'Started using agents',
    'journey3.desc':  'Handed the repetitive work to agents while keeping direction and judgment — throughput jumped.',
    'journey4.date': '2026',
    'journey4.title': 'Shipped these projects',
    'journey4.desc':  'Turned piled-up ideas into real things: GitHub search, a dialogue-tree editor, football score prediction, and this site with its blog.',
